...
const OperatorsDashboard = () => {
  ...
  // Fetch constants
  useEffect(() => {
    fetch("https://walrus-stats.brightlystake.com/api/walrus-constants")
      .then((res) => res.json())
  ...
  // Fetch data
  useEffect(() => {
    fetch("https://walrus-stats.brightlystake.com/api/get_latest_values")
      .then((res) => res.json())
  ...
  // // Fetch stake info
  // useEffect(() => {
  //   fetch("https://walrus-stats.brightlystake.com/api/stake-info")
  //     .then((res) => res.json())
